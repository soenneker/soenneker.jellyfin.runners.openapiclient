...
using Soenneker.Jellyfin.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Jellyfin.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Jellyfin:ClientGenerationUrl"] ?? "https://api.jellyfin.org/openapi/jellyfin-openapi-stable.json";
        ...
        if (filePath == null)
            throw new InvalidOperationException("Jellyfin OpenAPI document download failed.");
        ...
        // Jellyfin generates successfully in Kiota directly; the generic fixer recurses indefinitely on its schema.
        ...
        await _kiotaUtil.Generate(fixedFilePath, "JellyfinOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
